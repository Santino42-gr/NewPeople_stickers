...
Попробуйте позже или обратитесь в поддержку, если проблема повторяется.`,
  ...
  FACE_NOT_DETECTED: `❌ <b>Лицо не распознано</b>

Не удалось распознать лицо на вашем фото.

🤔 <b>Возможные причины:</b>
• На фото несколько лиц или лицо не видно четко
• Слишком темное фото или плохое качество  
• Лицо повернуто или частично скрыто
• Слишком маленькое лицо в кадре

📸 <b>Попробуйте загрузить другое фото:</b>
• С одним четко видимым лицом
• При хорошем освещении
• Лицо должно занимать достаточную часть кадра
• Избегайте очков и головных уборов

Отправьте новое фото, и я создам ваш стикер-пак! 🎭`,

  FACE_NOT_DETECTED_RETRY: `❌ <b>Лицо не распознано</b>

Попробуйте другое фото с четко видимым лицом при хорошем освещении.

Отправьте новое фото! 📸`,

  PHOTO_QUALITY_TIPS: `📸 <b>Советы для лучшего результата:</b>

• Используйте фото с хорошим освещением
• Лицо должно быть повернуто анфас
• Избегайте солнцезащитных очков
