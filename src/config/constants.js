...
const MESSAGES = {
  ...
  WELCOME: `🎭 <b>Добро пожаловать в New People Stickers!</b>
...
Скоро всё будет готово! 🚀`,
  ...
  PROCESSING_UPDATE: (completed, total) => 
    `⏳ <b>Обработка в процессе...</b>

Готово: ${completed}/${total} стикеров
...
Ваш персональный стикер-пак создан и доступен по ссылке:
${packUrl}

<b>Как использовать:</b>
• Нажмите на ссылку выше
• Добавьте стикеры в Telegram
• Используйте в чатах и делитесь с друзьями!

Стикер-пак: <code>${packName}</code>

Спасибо за использование New People Stickers! 🎭`,
